...
<div id="contadorPilotos" aria-label="Total de pilotos cadastrados">0 pilotos</div>
  <div class="ficha">
    ...
    <div class="campo"><label>Nome Completo</label><div class="linha">${piloto.nome}</div></div>
    <div class="campo"><label>CPF</label><div class="linha">${piloto.cpf}</div></div>
    <div class="campo"><label>Endereço</label><div class="linha">${piloto.endereco}</div></div>
    <div class="campo"><label>Cidade</label><div class="linha">${piloto.cidade}</div></div>
    <div class="campo"><label>Equipe</label><div class="linha">${piloto.equipe || '-'}</div></div>
    <div class="campo"><label>Evento</label><div class="linha">${nomeEvento}</div></div>
    <div class="campo"><label>Assinatura do Responsável</label><div class="linha">&nbsp;</div></div>
...
`;
  ...
  function mostrarResumoEquipes() {
    ...
    document.getElementById('btnGerarPDFResumo').addEventListener('click', gerarPDFResumo);
  }

  // Gerar PDF resumo com jsPDF
